...
export const Users03 = ({ className }) => {
  return (
    <svg
      className={`users-03 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
